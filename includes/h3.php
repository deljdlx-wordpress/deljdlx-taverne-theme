...
$theme->customizer->addSection('h3', 'H3 titles');
...
$theme->customizer->addPreview('h3', '.main-title');



new \Kirki\Field\Slider(
    [
        'settings'    => 'h3-margin-bottom',
...
$theme->customizer->addPreview('h3-margin-bottom', '.main-title');