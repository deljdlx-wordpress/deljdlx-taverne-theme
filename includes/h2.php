...
$theme->customizer->addSection('h2', 'H2 titles');
...
$theme->customizer->addPreview('h2', '.main-title');



new \Kirki\Field\Slider(
    [
        'settings'    => 'h2-margin-bottom',
...
$theme->customizer->addPreview('h2-margin-bottom', '.main-title');